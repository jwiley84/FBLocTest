...
namespace Facebook_Events_Bot
{
    ...
    public class FacebookEventsBot : IBot
    {
        ...
        public FacebookEventsBot(BotAccessors accessors, ConversationState conversationState)
        {
            if (accessors == null)
            {
            ...
            _dialogs.Add(new LocationDialog("syIBV1PMiwdUN50eNGaWhKmqSsOSNQXDSjIdUrARoxY",
